            ...
            _internal: {
                ...
                async setupPlugin(pluginPath) {
                    ...
                    const {
                        pluginOutput,
                        id,
                    } = virkshop._internal.importPlugin(pluginPath)
                        ...
                        // 
                            ...
                            setTimeout(() => {
                                for (const eventName of withoutSystemToolsListenerNames) {
                                    ...
                                    // intentionally dont await, the file is just a placeholder
                                    FileSystem.write({
                                        path: eventPath,
                                        ...
                                        data: shellApi.joinStatements([
                                            ...
                                            shellApi.callCommand(
                                                ...
                                                `
                                                    ...
                                                    const result = await pluginOutput.events[${JSON.stringify(eventName)}]()
                                ...
                                for (const eventName of nonBuiltinEventNames) {
                                    ...
                                    FileSystem.write({
                                        ...
                                        data: [
                                            ...
                                            `//       edit that file, not this one!`,
                                            `import { virkshop } from ${JSON.stringify(FileSystem.makeRelativePath({ from: virkshop.pathTo.commands, to: thisFile }))}`,
                                            `await (await virkshop._internal.importPlugin(${JSON.stringify(pluginPath)})).events[${JSON.stringify(eventName)}](...Deno.args)`,
                                        ].join("\n")
                                    })
                                }
                            }, 100)
