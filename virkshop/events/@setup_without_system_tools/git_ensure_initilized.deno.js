...
const fileSystemPromise   = import("https://deno.land/x/quickr@0.6.38/main/file_system.js")
const runToolsPromise     = import("https://deno.land/x/quickr@0.6.38/main/run.js")
            ...
            function createShellHookStringFor(hookName) {
                return `${start}
                    if [ -n "$VIRKSHOP_FOLDER" ]; then
                        deno eval --no-lock -q ${virkshop.shellApi.escapeShellArgument(`
